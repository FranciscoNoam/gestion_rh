<span class="mt-0 d-flex justify-content-end text-center" style="font-size: 20px;">
    ...
    <a href="{{ route('demandeabsence.pagination',[$pagination_attente["debut_aff"],($pagination_accepter["debut_aff"] - $pagination_accepter["nb_limit"]),$pagination_refuser["debut_aff"],'&accepter'] ) }}" role="button" class="mx-1"><i class='fa fa-angle-left'></i></a>
    <a href="#"role="button" class="mx-1 text-muted" style=" color:black; pointer-events: none;cursor: default;"><i  class='fa fa-angle-right'></i></a>
    ...
    {{-- -------- --}}
    <a href="#"role="button" class="mx-1 text-muted" style=" color:black; pointer-events: none;cursor: default;"><i class='fa fa-angle-left'></i></a>
    <a href="{{ route('demandeabsence.pagination',[$pagination_attente["debut_aff"],($pagination_accepter["debut_aff"] + $pagination_accepter["nb_limit"]),$pagination_refuser["debut_aff"],'&accepter' ]) }}" role="button" class="mx-1"><i class='fa fa-angle-right'></i></a>


    @endif

    {{-- =============== condition pagination_attente ==================== --}}
    @elseif ($pagination_accepter["debut_aff"] == $pagination_accepter["fin_aff"] || $pagination_accepter["debut_aff"]>
    $pagination_accepter["fin_aff"])
    ...
    @else
    {{-- -------- --}}
    <a href="{{ route('demandeabsence.pagination',[$pagination_attente["debut_aff"],($pagination_accepter["debut_aff"] - $pagination_accepter["nb_limit"]),$pagination_refuser["debut_aff"],'&accepter'] ) }}"
