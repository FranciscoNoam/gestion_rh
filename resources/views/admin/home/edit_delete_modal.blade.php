<div class="modal fade " id="dropdataBoot{{ $emp->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
    tabindex="-1">

    <div class="modal-dialog   shadow p-3 lg-body  rounded">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="text-center">Suppression de "{{ $emp->name." ".$emp->username }}"</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('employe.destroy',$emp->id)}}" class="formulaire_new mt-5" id="msform_facture"
                ...
                <div class="modal-footer d-flex  justify-content-center align-center">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Non, j'annule</button>
                    <button type="submit" class="btn btn-outline-success">Oui, je le veux</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="staticBackdrop{{ $emp->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
    tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="d-flex  justify-content-center align-center">
                     ...
                     <h4 class="text-center"> Modification de "{{ $emp->name." ".$emp->username }}" </h4>

                <form action="{{route('employe.update',$emp->id)}}" class="formulaire_new mt-5" id="msform_facture"
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="text" name="nom" value="{{ $emp->name }}"
                                    class="form-control input_inscription" placeholder="Nom" id="nom" required />
                                @error('nom')
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="text" name="prenom" value="{{ $emp->username }}"
                                    class="form-control input_inscription" placeholder="Prénom" id="prenom" />
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="email" name="email" value="{{ $emp->email }}"
                                    class="form-control input_inscription" placeholder="email" id="email" required />
                                @error('email')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="text" name="phone" value="{{ $emp->phone }}"
                                    class="form-control input_inscription" placeholder="Phone" id="phone" />
                                @error('phone')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="number" name="cin" value="{{ $emp->cin }}"
                                    class="form-control input_inscription" placeholder="cin" id="cin" required />
                                @error('cin')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                {{-- <input type="text" name="poste" value="{{ $emp->poste }}"
                                    class="form-control input_inscription" placeholder="Poste occupé" id="poste" /> --}}
                                @error('poste')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="date" name="naissance" value="{{ $emp->naissance }}"
                                    class="form-control input_inscription" id="naissance" required />
                                @error('naissance')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="date" name="debut_job" value="{{ $emp->debut_job }}"
                                    class="form-control input_inscription" id="debut_job" required />
                                @error('debut_job')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="text" name="adresse" class="form-control input_inscription"
                                    placeholder="adresse" value="{{ $emp->adresse }}" id="adresse" required />
                                @error('adresse')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group my-1">
                                ...
                                <input type="number" name="salaire" class="form-control input_inscription"
                                    placeholder="salaire" value="{{ $emp->salaire }}" id="salaire" required />
                                @error('salaire')
                                <span style="color:#ff0000;"> {{$message}} </span>
                                @enderror
                            </div>
